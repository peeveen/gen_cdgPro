...
/// </summary>
/// <param name="color">Color to replace scrolled pixels with.</param>
/// <param name="hScroll">Number of blocks to scroll horizontally (can be negative).</param>
/// <param name="hScrollOffset">Number of pixels to scroll horizontally, for fine tuning (can be negative).</param>
/// <param name="vScroll">Number of blocks to scroll vertically (can be negative).</param>
